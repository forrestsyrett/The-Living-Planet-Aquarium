...
class MapGalleryController {
    ...
    let banquetHall = MapGalleries(name: "Banquet Hall", image1: #imageLiteral(resourceName: "banquet"), info: "Our banquet hall is perfect for company parties, corporate meetings, and even weddings! Contact us for more information about our event spaces and pricing.")
    ...
    let cafe = MapGalleries(name: "The Reef Cafe", image1: #imageLiteral(resourceName: "cafe"), info: "The Reef Cafe offers a fine selection of refreshments, from hot meals to on-the-go snacks. Located in the main lobby. Tap the button below to view the menu!")
}

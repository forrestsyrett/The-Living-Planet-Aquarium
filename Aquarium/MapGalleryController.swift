...
class MapGalleryController {
    ...
    let tukis = MapGalleries(name: "\nTuki's Island Play & Party Center", image1: #imageLiteral(resourceName: "tukis"), info: "\nEntry is free with a valid Aquarium Membership.\nGeneral Admission (ages 3-12) costs $3.00 each.\n\nCome celebrate with us! Tuki's Island also features 4 private party rooms; book your party today!")
    let banquetHall = MapGalleries(name: "Banquet Hall", image1: #imageLiteral(resourceName: "banquet"), info: "\nOur banquet hall is perfect for company parties, corporate meetings, and even weddings!")
    let amenities = MapGalleries(name: "Amenities", image1: #imageLiteral(resourceName: "giftShop"), info: "The aquarium has many amenities to help ensure your visit is memorable. Amenities inlcude:\n- Cafe Avalon\n- Aquarium gift shop\n- Wheelchair rentals\n- Free Wifi")
    ...
    let educationCenter = MapGalleries(name: "\nEducation Center", image1: #imageLiteral(resourceName: "education"), info: "The educational mission of the Loveland Living Planet Aquarium is to provide unique learning environments for learners of all ages to encourage an ongoing discovery of the Earth’s diverse, yet fragile ecosystems.")
    let deepSeaLab = MapGalleries(name: "Deep Sea Lab", image1: #imageLiteral(resourceName: "deepSea"), info: "\nCome see and experience the animals that live in the deep sea. Some of these creatures have thrived and lived in deep seas for millions of years.")
